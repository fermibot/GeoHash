...
class GeohashUnittest(unittest.TestCase):
    ...
    def test_something(self):
        ...
        for hash_kind in [32, 64, 256, 4096]:
            ...
            calculated_hash = geo_hash.nums_to_geohash(lat_long_pair)
            calculated_nums = [round(x, 4) for x in geo_hash.hash_to_nums(calculated_hash, split_type=2)]
            ...
            if hash_kind in [256, 4096]:
                ...
                calculated_nums = [round(x, 4) for x in geo_hash.hash_to_nums(calculated_hash, split_type=4)]
